...
/*   Updated: 2024/07/01 09:45:40 by Tiago                  /_____/ U         */
/*                                                                            */
/* ************************************************************************** */
...
void	ray_set_variables(t_gm *gm, int x);
void	ray_check_steps(t_gm *gm);
void	ray_set_length(t_gm *gm);
void	ray_check_sides(t_gm *gm, t_img *curimg);
